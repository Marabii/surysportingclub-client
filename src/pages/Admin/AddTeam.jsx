...
export default function AddTeam() {
  ...
  const { getRootProps, getInputProps, isDragActive } = useDropzone({
    ...
    onDropRejected: () =>
      toast.error("Invalid file type. Only JPEG, PNG, or GIF accepted."),
  });
    ...
    <div className="add-team-section">
      ...
      <form className="team-form" onSubmit={handleTeamSubmit}>
        ...
        >
          ...
          {formData.teamImage && (
            <img
              src={URL.createObjectURL(formData.teamImage)}
              alt="Preview"
              style={{
                maxWidth: "100%",
                maxHeight: "100px",
        ...
        <input
          ...
          value={formData.nombreEquipe}
          onChange={(e) => handleInputChange("nombreEquipe", e.target.value)}
          required
        />

        <input
          type="text"
          placeholder="Année de naissance des joueurs"
        ...
        <input
          ...
          value={formData.seancesEntrainement}
          onChange={(e) =>
            handleInputChange("seancesEntrainement", e.target.value)
          }
          required
        />
        ...
        <input
          type="text"
          placeholder="Mots des coaches"
          value={formData.motDesCoaches}
          onChange={(e) => handleInputChange("motDesCoaches", e.target.value)}
          required
        />
        ...
        <div className="role-manager">
          <div className="input-container">
            ...
            <input
              ...
              className="input-field"
            />
            <button onClick={(e) => addRole(e)} className="add-button">
              Ajouter un rôle
            </button>
          </div>
        ...
        <button type="submit" className="submit-team">
          Ajouter l'equipe
        </button>
        {uploadProgress > 0 && (
